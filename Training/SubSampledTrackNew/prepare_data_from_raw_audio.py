...
Simple version: directly points to your audio data
"""
...
#   │   └── audio_data/          ← DATA
#   └── Training/
#       └── SubSampledTrackNew/  ← SCRIPT IS HERE
#
# So from current location, go up 2 levels to root, then into DataProcessing/audio_data
